...
using IMDBanalog.Domain.Repositories;
...
namespace IMDBanalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IFilm, FilmRepository>();
        ...
        private async Task CreateUserRoles(IServiceProvider serviceProvider)
        {
            ...
            ApplicationUser user = await UserManager.FindByEmailAsync("cwewqe@gmail.com");
